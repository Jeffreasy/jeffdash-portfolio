...
export default function ProjectForm({
  ...
  // State voor NIEUWE afbeelding previews + alt teksten
  const [newImagePreviews, setNewImagePreviews] = useState<NewImagePreview[]>([]);

  // --- Effect voor Object URL Cleanup (alleen voor NIEUWE previews) --- 
  useEffect(() => {
    return () => {
  ...
  // --- Handlers voor NIEUWE afbeeldingen --- 
  const handleFileChange = (files: File[] | null) => {
    ...
    // Voeg alleen echt nieuwe bestanden toe aan de preview state
  ...
  // --- Handler voor alt tekst van BESTAANDE afbeeldingen --- 
